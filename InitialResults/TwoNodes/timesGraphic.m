...
pingNoAttackTimes = csvread('pingWithNoAttack/times.txt');
pingAttackTimes = csvread('pingWithAttack/times.txt');
pingDefenseTimes = csvread('pingWithDefense/times.txt');
